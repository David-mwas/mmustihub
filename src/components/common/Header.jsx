...
const Header = ({ setShowSidebar }) => {
  ...
  return (
    <>
      <header className="fixed top-0 right-0 bg-white w-screen text-black shadow-md z-[9999] justify-between items-center px-6 flex h-[80px] text-center">
              ...
              <Link to="/" onClick={window.scrollTo(0, 0)}>
                <div className="flex h-full gap-2 items-center font-semibold justify-center md:ml-16">
                  <img
                    src={LogoImg}
                    alt=""
                    className="h-28 object-contain w-28"
                  />
                </div>
              </Link>
            </div>
